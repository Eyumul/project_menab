    ...
    <div class="bg-black h-screen">
        <div class="text-white bg-black">
            <nav class="h-20 pl-[138px] pt-[50px] space-x-4 flex">
                <div  @click="goBack" class="cursor-pointer flex hover:text-[#0089D0]" >
        ...
        <div class="h-full bg-black text-white">
            ...
            <div class="flex items-center px-[138px] py-12">
                ...
                <div class="movieDetails flex flex-col ml-28 space-y-6 items-center">
                    ...
                    <p v-if="data.movie[0].ratings_aggregate.aggregate.avg.rating" class="font-black text-[14px] w-full">ABC_cinema Rating <span class="textColor ml-4 text-[24px]">{{data.movie[0].ratings_aggregate.aggregate.avg.rating.toFixed(1)}}/5</span></p>
...
<script setup>
  ...
  if (window.history.length > 1) {
    ...
    // If no history, redirect to a fallback page (e.g., homepage)
    this.$router.push('/');
  }
}
    const query = gql`
...
setTimeout( async () => {
    if(process.client){
        ...
        const movieId = ref('')
        movieId.value = data.value.movie[0].id
