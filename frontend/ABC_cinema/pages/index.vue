<template>
    <div class="h-full bg-black text-white pb-40">
        ...
        <div class="flex items-center px-36 py-20">
            <div class="thumbnail"></div>
            <div class="line ml-12"></div>
            <div class="movieDetails flex flex-col ml-28 space-y-6 items-center">
                <div class="flex flex-col space-y-6">
                    <p class="movieTitle self-center ">Kingdom of the planet of the apes</p>
                ...
                <div class="flex space-x-7 button justify-center items-center">
                    ...
                    <p class="text-2xl font-black">Buy Ticket</p>
                </div>
            </div>
        </div>
        <div class="flex space-x-8 justify-center pt-16 content end">
            <img src="/public/figmaImage/dashboard.png"/>
            <p class="s32 font-normal">My Dashboard</p>
        </div>
        <div class="flex flex-col py20">
            <div>
                <p class="s24 textColor font-normal">Booked movies</p>
                <!-- Movie cards -->
                <movieCardTwo/>
            </div>
            <div>
                <p class="s24 textColor font-normal">Saved movies</p>
                <!-- Movie cards -->
                <MovieCardOne/>
            </div>
        </div>
