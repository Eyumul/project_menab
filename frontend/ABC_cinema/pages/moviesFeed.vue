    ...
    <div class="h-full bg-black text-white pb-40">
        ...
        <div v-else-if = "browsetype == 'Directors'">
            <div class="flex pl-[138px] pt-10 space-x-4">
                ...
                <input v-model="searchtext" type="text" placeholder="Filter by director" class="w-[150px] h-[20px] border-none bg-black ring-[2px] ring-[rgb(0,137,208,0.5)] text-[18px] text-center rounded-[5px]"/>
